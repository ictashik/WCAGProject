...
class Tracker:
    ...
    def findChanges(self):
        ...
        # for changed files sum up the differences between old and new sizes for every changed file sum(map(lambda (old_size, new_size):abs(old_size-new_size), self.changed_files.values()))
        self.changed_total_size = 15
